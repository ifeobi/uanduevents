...
function Terms() {
  return (
    <main className="terms-container">
      ...
      <p>
        Thank you for choosing U&U Designs for your Event Planning & Design. The
        retainage of $ equals to 50% of your order total is required to reserve
        a date and is applied towards your final balance. Your order will not be
      ...
      <p>
        Delivery and pick up rates are based on the estimated load/unload time,
        distance of the location of your event as well as the required
        ...
        Minimum rental order for deliveries is $50.00 dollars excluding delivery
        and pick-up service fee. Please note: Our regular delivery and pickup
        times are Monday through Sunday, 8 AM-7 PM. After business hours will be
      ...
      <p>
        Items that require set-up /Teardown will be charged an additional charge
        based on the time required to complete the installation-setup and or
        teardown.
      </p>
      ...
      <p>
        ...
        all claims, actions, suits, proceedings, costs, expenses, fees, damages
        and liabilities, including, but not limited to, reasonable attorney fees
        and costs, arising by reason of injury, damage, or death to persons or
        property, in connection on with or resulting from the use of the leased
        equipment. This includes, but is not limited to, the manufacture,
        selection, delivery, possession, use, operation, or return of the
        equipment. BB Décor and Rental, cannot, under any circumstances, be held
        liable for injuries as a result of inappropriate use, God, nature, or
        other conditions beyond its control or knowledge.
      </p>

      <br />
      <p>
        All sales are final. No refund and non transferable. Once we deliver the
        balloon, flowers and rental to the event, we are no longer liable for
        any damages or issues regarding the balloon or other services.
      </p>
      ...
      <p>
        ...
        expected. By their nature, balloons are susceptible to the effects of
        weather elements such as, but not limited to, rain, sun, temperature
        changes, and wind. The client understands that any balloon structure
        displayed outdoors is not guaranteed to last for any specific time
        period and that artist is not liable for the balloon structure lasting
        for any period of time. Artist reserves the right to cancel delivery in
        case of inclement weather or in the event that public or private roads
        are impassable on the delivery date.
      </p>
